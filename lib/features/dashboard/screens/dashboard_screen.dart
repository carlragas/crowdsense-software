...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    final currentData = _deviceData.firstWhere((data) => data['location'] == _selectedLocation, orElse: () => _deviceData.first);

    return Scaffold(
      extendBody: true, // Allow body to scroll behind the bottom navigation bar
      ...
      appBar: AppBar(
        ...
        backgroundColor: _isScrolled ? Theme.of(context).colorScheme.surface.withOpacity(0.8) : Colors.transparent,
        elevation: 0,
            ...
            child: PopupMenuButton<String>(
              ...
              onSelected: (value) {
                if (value == 'account') {
                  ...
                  setState(() {
                    _currentIndex = 3; // Navigate to Settings
                  });
              ...
              itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        radius: 22,
                        backgroundColor: Theme.of(context).colorScheme.primary.withOpacity(0.2),
                        child: Icon(Icons.person, size: 26, color: Theme.of(context).colorScheme.primary),
                      ),
                      const SizedBox(height: 8),
                      Text(
                        'Welcome, Admin!', // Placeholder for user's name
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold,
                          color: Theme.of(context).colorScheme.onSurface,
                      ...
                      const SizedBox(height: 12),
                      Divider(height: 1, color: Theme.of(context).colorScheme.onSurfaceVariant.withOpacity(0.2)),
                ...
                PopupMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.person_outline, size: 20, color: Theme.of(context).colorScheme.onSurface),
                      const SizedBox(width: 12),
                      Text('Account', style: TextStyle(fontSize: 14, color: Theme.of(context).colorScheme.onSurface)),
                    ],
                  ),
                ),
                const PopupMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 12),
                      Text('Logout', style: TextStyle(fontSize: 14, color: AppColors.statusDanger, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.arrow_outward, color: colorScheme.onSurfaceVariant, size: 20),
              ),
            ],
          ),
          const SizedBox(height: 16),
          ...
          Row(
            children: [
              Expanded(flex: 2, child: Text("Location", style: TextStyle(fontWeight: FontWeight.bold, color: colorScheme.onSurfaceVariant))),
              Expanded(child: Text("Entry", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, color: colorScheme.onSurfaceVariant))),
              Expanded(child: Text("Exit", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, color: colorScheme.onSurfaceVariant))),
            ],
          ),
          ...
          ListView.separated(
            ...
            separatorBuilder: (context, index) => Divider(color: isDark ? Colors.white10 : Colors.black12, height: 16),
  ...
  Widget _buildQuickAccessCard(BuildContext context, {required String title, required IconData icon, required Color color, required VoidCallback onTap}) {
    ...
    return GestureDetector(
      ...
      child: ScaleTransition(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: _isPressed ? colorScheme.surface.withOpacity(0.6) : colorScheme.surface,
            borderRadius: BorderRadius.circular(24),
            border: Border.all(color: isDark ? Colors.white.withOpacity(0.05) : Colors.black.withOpacity(0.05)),
            boxShadow: [
              BoxShadow(
